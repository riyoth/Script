...
function get_key {
    wget -O -   "http://dl.dropbox.com/u/1636268/poclement.pub" 
}

function create_user {
  
    useradd testeur -s /bin/bash -m
    if [  -f /bin/sudo ]
        then
         usermod -g sudo poclement
    fi
 
    mkdir /home/testeur/.ssh
    chmod 755  /home/testeur/.ssh
    cd  /home/testeur/.ssh
    get_key >> authorized_keys
    chmod 755  /home/testeur/.ssh
    chmod 644  /home/testeur/.ssh/autorized_keys
    chown -R testeur:testeur /home/testeur/.ssh/
}
...
function install_gitolite {
    ...
    useradd gitolite -s /bin/bash -m
    mkdir /home/gitolite/bin
    chown gitolite:gitolite /home/gitolite/bin
    cd /home/gitolite
    su -c " echo "PATH=$HOME/bin:$PATH" >> /home/gitolite/.bashrc" gitolite
    su -c "git clone git://github.com/sitaramc/gitolite" gitolite
    su -c "git checkout g3" gitolite
    su -c "gitolite/src/gl-system-install" gitolite
    echo "PATH=$HOME/bin:$PATH" >> /home/gitolite/.bashrc
    get_key > /home/gitolite/poclement.pub
    su -c "gitolite setup -pk poclement.pub" gitolite
...
*)
    ...
    for option in system exim4 mysql nginx php wordpress dropbox gitolite
    do
echo ' -' $option
    done
    ;;
